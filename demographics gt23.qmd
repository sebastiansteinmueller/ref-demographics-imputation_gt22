...
imputations <- readRDS("output/imputations400_20230509.rds")
...
imputations.world <- imputations |>
  ...
  mutate(children = rowSums(select(., female_0_4:female_12_17, male_0_4:male_12_17)),
         girls = rowSums(select(., male_0_4:male_12_17)),
         boys = rowSums(select(., female_0_4:female_12_17)),
         adults = rowSums(select(., female_18_59, female_60, male_18_59, male_60)),
